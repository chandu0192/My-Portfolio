...
export default function Contact() {
  return (
    ...
    >
      ...
      <p className="text-neutral-700 dark:text-neutral-300 mb-10 max-w-2xl">
      ...
      <address className="not-italic flex gap-8 items-center text-3xl text-neutral-700 dark:text-neutral-300">
        <a
        ...
        <a href="https://twitter.com/Chitransh8918/intent/tweet?text=Hi%20I%20saw%20your%20portfolio%0Ahttps://chitranshdev.in%0Aand%20want%20to%20talk" target="_blank" aria-label="Twitter profile" rel="noreferrer" className="hover:text-indigo-400 hover:scale-110 transition focus-visible:outline focus-visible:outline-2 focus-visible:outline-indigo-500"><FaTwitter /></a>
        <a href="https://wa.me/919216533729?text=Hi%20I%20saw%20your%20portfolio%0Ahttps://chitranshdev.in%0Aand%20want%20to%20talk" target="_blank" aria-label="WhatsApp profile" rel="noreferrer" className="hover:text-indigo-400 hover:scale-110 transition focus-visible:outline focus-visible:outline-2 focus-visible:outline-indigo-500"><FaWhatsapp /></a>
        <a href="https://t.me/freelancechitransh?text=Hi%20I%20saw%20your%20portfolio%0Ahttps://chitranshdev.in%0Aand%20want%20to%20talk" target="_blank" aria-label="Telegram profile" rel="noreferrer" className="hover:text-indigo-400 hover:scale-110 transition focus-visible:outline focus-visible:outline-2 focus-visible:outline-indigo-500"><FaTelegram /></a>
        {/* </div> */}
      </address>

      <div className="flex items-center gap-3 mt-8 text-neutral-700 dark:text-neutral-300">
        <FaPhone />
