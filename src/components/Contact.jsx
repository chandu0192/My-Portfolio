  ...
  return (
    ...
    >
      ...
      <div className="flex gap-8 items-center text-3xl muted-text">
        ...
        <a href="https://twitter.com/Chitransh8918/intent/tweet?text=Hi%20I%20saw%20your%20portfolio%0Ahttps://buildwithchitransh.netlify.app%0Aand%20want%20to%20talk" target="_blank" className="hover:text-indigo-400 hover:scale-130 transition"><FaTwitter /></a>
        <a href="https://wa.me/919216533729?text=Hi%20I%20saw%20your%20portfolio%0Ahttps://buildwithchitransh.netlify.app%0Aand%20want%20to%20talk" target="_blank" className="hover:text-indigo-400 hover:scale-130 transition"><FaWhatsapp /></a>
        <a href="https://t.me/freelancechitransh?text=Hi%20I%20saw%20your%20portfolio%0Ahttps://buildwithchitransh.netlify.app%0Aand%20want%20to%20talk" target="_blank" className="hover:text-indigo-400 hover:scale-130 transition"><FaTelegram /></a>
      </div>
